...
vs_pol[0] = float(input("Digite o valor do modulo de Vs (pol) [kV] :"))
vs_pol[1] = float(input("Digite o valor do grau de Vs (pol) :"))
is_pol[0] = float(input("Digite o valor do modulo de Is (pol) [kA] :"))
is_pol[1] = float(input("Digite o valor do grau de Is (pol) :"))
vr_pol[0] = float(input("Digite o valor do modulo de Vr (pol) [kV] :"))
vr_pol[1] = float(input("Digite o valor do grau de Vr (pol) :"))
ir_pol[0] = float(input("Digite o valor do modulo de Ir (pol) [kA] :"))
ir_pol[1] = float(input("Digite o valor do grau de Ir (pol) :"))

vs_rec = complex(math.cos(vs_pol[1]*(math.pi/180))*vs_pol[0],math.sin(vs_pol[1]*(math.pi/180))*vs_pol[0])
is_rec = complex(math.cos(is_pol[1]*(math.pi/180))*is_pol[0],math.sin(is_pol[1]*(math.pi/180))*is_pol[0])
vr_rec = complex(math.cos(vr_pol[1]*(math.pi/180))*vr_pol[0],math.sin(vr_pol[1]*(math.pi/180))*vr_pol[0])
ir_rec = complex(math.cos(ir_pol[1]*(math.pi/180))*ir_pol[0],math.sin(ir_pol[1]*(math.pi/180))*ir_pol[0])
...
A_rec = (vs_rec*is_rec+vr_rec*ir_rec)/(vs_rec*ir_rec+vr_rec*is_rec)
raio = cmath.polar(A_rec)
angulo = raio[1]*(180/math.pi)
A_pol = [raio[0], angulo]

B_rec = (vs_rec*vs_rec-vr_rec*vr_rec)/(vs_rec*ir_rec+vr_rec*is_rec)
raio = cmath.polar(B_rec)
angulo = raio[1]*(180/math.pi)
B_pol = [raio[0], angulo]

C_rec = (is_rec*is_rec-ir_rec*ir_rec)/(vs_rec*ir_rec+vr_rec*is_rec)
raio = cmath.polar(C_rec)
angulo = raio[1]*(180/math.pi)
C_pol = [raio[0], angulo]

D_rec = (vs_rec*is_rec+vr_rec*ir_rec)/(vs_rec*ir_rec+vr_rec*is_rec)
...
print("A = D = (Vs*Is+Vr*Ir)/(Vs*Ir+Vr*Is) // B = (Vs^2-Vr^2)/(Vs*Ir+Vr*Is) [ohm] // C = (Is^2-Ir^2)/(Vs*Ir+Vr*Is) [S]")
print("E = H = A // F = -B [ohm] // G = -C [S]")
...
zc_rec = cmath.sqrt(B_rec/C_rec)
raio = cmath.polar(zc_rec)
angulo = raio[1]*(180/math.pi)
zc_pol = [raio[0], angulo]
print("\n* A impedancia caracteristica Zc = sqrt(B/C) [ohm]\n// rec:", zc_rec, "// pol:", zc_pol,"//")
...
z_rec = gama_rec*zc_rec
raio = cmath.polar(z_rec)
angulo = raio[1]*(180/math.pi)
z_pol = [raio[0], angulo]

y_rec = gama_rec/zc_rec
